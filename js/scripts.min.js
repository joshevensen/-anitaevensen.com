...
;$(function(){$(document).on("click","a.js-smoothScroll",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);if(e=e.length?e:$("[name="+this.hash.slice(1)+"]"),e.length)return $("html,body").animate({scrollTop:e.offset().top-60},1500),!1}})});
!function(){$(".js-openNav").click(function(){$("#siteNav").toggleClass("open")}),$("#closeNav").click(function(){$("#siteNav").toggleClass("open")})}();
!function(){function e(){t.fadeOut(),n.removeClass("open")}var t=$("#modalOverlay"),n=$("#modal");$(".js-openModal").click(function(){t.fadeIn(),n.addClass("open")}),$(".js-closeModal").click(e),t.click(e)}();
